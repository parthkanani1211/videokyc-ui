                  ...
                  return (
                    <td className="py-2 last-col">
                      <Button
                        ...
                        size="sm"
                        disabled={
                          KYC_STATUSES.CANCELED === videoKYCRequestStatus ||
                          KYC_STATUSES.TIMEOUT === videoKYCRequestStatus
                        }
                        onClick={() => {
                          variant === "primary" ? onJoinClick(item) : onViewClick(item);
                        }}
                      >
                        {variant === "primary" ? "Join" : "View"}
                      </Button>
                    </td>
                  );
                },
        ...
        <CCard.Header>
          ...
          >
            <Flex
              ...
              pb={{ md: "20px" }}
            >
              <Box cursor="pointer" pl="10px" onClick={() => setCurrentTab(0)}>
                <Text
                  as="h5"
                ...
                {/* <Box
                  ...
                  bottom="-1px"
                  left={{
                    xs: currentTab === 1 ? 0 : "39vw",
                    md: currentTab === 1 ? 0 : "180px",
                    sm: currentTab === 1 ? 0 : 0,
                  }}
                  height="5px"
                  width={{
                    xs: currentTab === 1 ? 0 : "45vw",
                    md: currentTab === 1 ? 0 : "200px",
                    sm: currentTab === 1? 0 : "130px",
                  }}
                  bg="blue.500"
                  transition="all .3s"
                /> */}
              ...
              <Box ml="20px" cursor="pointer" pl="10px" onClick={() => setCurrentTab(1)}>
                <Text
                  as="h5"
                  style={{ fontWeight: "500" }}
